...
import { getWindowsByName } from "./index";
import { randomString } from "../js-help/string";
import { useLocalService } from "src/utils/injecter";
...
/** 主进程的窗口名 */
const MAIN_PROCESS = "MAIN_PROCESS";
